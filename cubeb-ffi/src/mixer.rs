...
static CHANNEL_LAYOUT_3F1LFE: &'static [Channel] = &[ CHANNEL_LEFT, CHANNEL_RIGHT, CHANNEL_CENTER, CHANNEL_LFE, CHANNEL_RCENTER ];
static CHANNEL_LAYOUT_2F2: &'static [Channel] = &[ CHANNEL_LEFT, CHANNEL_RIGHT, CHANNEL_LS, CHANNEL_RS ];
static CHANNEL_LAYOUT_2F2LFE: &'static [Channel] = &[ CHANNEL_LEFT, CHANNEL_RIGHT, CHANNEL_LFE, CHANNEL_LS, CHANNEL_RS ];
static CHANNEL_LAYOUT_3F2: &'static [Channel] = &[ CHANNEL_LEFT, CHANNEL_RIGHT, CHANNEL_CENTER, CHANNEL_LS, CHANNEL_RS ];
static CHANNEL_LAYOUT_3F2LFE: &'static [Channel] = &[ CHANNEL_LEFT, CHANNEL_RIGHT, CHANNEL_CENTER, CHANNEL_LFE, CHANNEL_LS, CHANNEL_RS ];
static CHANNEL_LAYOUT_3F3RLFE: &'static [Channel] = &[ CHANNEL_LEFT, CHANNEL_RIGHT, CHANNEL_CENTER, CHANNEL_LFE, CHANNEL_RCENTER, CHANNEL_LS, CHANNEL_RS ];
static CHANNEL_LAYOUT_3F4LFE: &'static [Channel] = &[ CHANNEL_LEFT, CHANNEL_RIGHT, CHANNEL_CENTER, CHANNEL_LFE, CHANNEL_RLS, CHANNEL_RRS, CHANNEL_LS, CHANNEL_RS ];
