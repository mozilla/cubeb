...
enum {
  ...
  CUBEB_LAYOUT_3F4_LFE = CHANNEL_FRONT_LEFT | CHANNEL_FRONT_RIGHT |
                         ...
                         CHANNEL_BACK_LEFT | CHANNEL_BACK_RIGHT |
                         CHANNEL_SIDE_LEFT | CHANNEL_SIDE_RIGHT,
  // FFmpeg layout compatible definition
  AV_CH_LAYOUT_STEREO = CHANNEL_FRONT_LEFT | CHANNEL_FRONT_RIGHT,
  AV_CH_LAYOUT_2POINT1 = AV_CH_LAYOUT_STEREO | CHANNEL_LOW_FREQUENCY,
  AV_CH_LAYOUT_2_1 = AV_CH_LAYOUT_STEREO | CHANNEL_BACK_CENTER,
  AV_CH_LAYOUT_SURROUND = AV_CH_LAYOUT_STEREO | CHANNEL_FRONT_CENTER,
  AV_CH_LAYOUT_3POINT1 = AV_CH_LAYOUT_SURROUND | CHANNEL_LOW_FREQUENCY,
  AV_CH_LAYOUT_4POINT0 = AV_CH_LAYOUT_SURROUND | CHANNEL_BACK_CENTER,
  AV_CH_LAYOUT_4POINT1 = AV_CH_LAYOUT_4POINT0 | CHANNEL_LOW_FREQUENCY,
  AV_CH_LAYOUT_2_2 =
    AV_CH_LAYOUT_STEREO | CHANNEL_SIDE_LEFT | CHANNEL_SIDE_RIGHT,
  AV_CH_LAYOUT_QUAD =
    AV_CH_LAYOUT_STEREO | CHANNEL_BACK_LEFT | CHANNEL_BACK_RIGHT,
  AV_CH_LAYOUT_5POINT0 =
    AV_CH_LAYOUT_SURROUND | CHANNEL_SIDE_LEFT | CHANNEL_SIDE_RIGHT,
  AV_CH_LAYOUT_5POINT1 = AV_CH_LAYOUT_5POINT0 | CHANNEL_LOW_FREQUENCY,
  AV_CH_LAYOUT_5POINT0_BACK =
    AV_CH_LAYOUT_SURROUND | CHANNEL_BACK_LEFT | CHANNEL_BACK_RIGHT,
  AV_CH_LAYOUT_5POINT1_BACK = AV_CH_LAYOUT_5POINT0_BACK | CHANNEL_LOW_FREQUENCY,
  AV_CH_LAYOUT_6POINT0 = AV_CH_LAYOUT_5POINT0 | CHANNEL_BACK_CENTER,
  AV_CH_LAYOUT_6POINT0_FRONT = AV_CH_LAYOUT_2_2 | CHANNEL_FRONT_LEFT_OF_CENTER |
                               CHANNEL_FRONT_RIGHT_OF_CENTER,
  AV_CH_LAYOUT_HEXAGONAL = AV_CH_LAYOUT_5POINT0_BACK | CHANNEL_BACK_CENTER,
  AV_CH_LAYOUT_6POINT1 = AV_CH_LAYOUT_5POINT1 | CHANNEL_BACK_CENTER,
  AV_CH_LAYOUT_6POINT1_BACK = AV_CH_LAYOUT_5POINT1_BACK | CHANNEL_BACK_CENTER,
  AV_CH_LAYOUT_6POINT1_FRONT =
    AV_CH_LAYOUT_6POINT0_FRONT | CHANNEL_LOW_FREQUENCY,
  AV_CH_LAYOUT_7POINT0 =
    AV_CH_LAYOUT_5POINT0 | CHANNEL_BACK_LEFT | CHANNEL_BACK_RIGHT,
  AV_CH_LAYOUT_7POINT0_FRONT = AV_CH_LAYOUT_5POINT0 |
                               CHANNEL_FRONT_LEFT_OF_CENTER |
                               CHANNEL_FRONT_RIGHT_OF_CENTER,
  AV_CH_LAYOUT_7POINT1 =
    AV_CH_LAYOUT_5POINT1 | CHANNEL_BACK_LEFT | CHANNEL_BACK_RIGHT,
  ...
  AV_CH_LAYOUT_7POINT1_WIDE_BACK = AV_CH_LAYOUT_5POINT1_BACK |
                                   CHANNEL_FRONT_LEFT_OF_CENTER |
                                   CHANNEL_FRONT_RIGHT_OF_CENTER,
  AV_CH_LAYOUT_OCTAGONAL = AV_CH_LAYOUT_5POINT0 | CHANNEL_BACK_LEFT |
