...
pub type pa_io_event_cb_t = Option<unsafe extern fn(ea: *mut pa_mainloop_api,
                                                        e: *mut pa_io_event,
                                                        fd: c_int,
                                                        events: pa_io_event_flags_t,
                                                        userdata: *mut c_void)>;
pub type pa_io_event_destroy_cb_t = Option<unsafe extern fn(a: *mut pa_mainloop_api,
                                                            e: *mut pa_io_event,
                                                            userdata: *mut c_void)>;
pub enum pa_time_event { }
pub type pa_time_event_cb_t = Option<unsafe extern fn(a: *mut pa_mainloop_api,
                                                      e: *mut pa_time_event,
                                                      tv: *const timeval,
                                                      userdata: *mut c_void)>;
pub type pa_time_event_destroy_cb_t = Option<unsafe extern fn(a: *mut pa_mainloop_api,
                                                              e: *mut pa_time_event,
                                                              userdata: *mut c_void)>;

pub enum pa_defer_event { }
pub type pa_defer_event_cb_t = Option<unsafe extern fn(a: *mut pa_mainloop_api,
                                                       e: *mut pa_defer_event,
                                                       userdata: *mut c_void)>;
pub type pa_defer_event_destroy_cb_t = Option<unsafe extern fn(a: *mut pa_mainloop_api,
                                                               e: *mut pa_defer_event,
                                                               userdata: *mut c_void)>;
...
pub struct pa_mainloop_api {
    ...
    pub io_new: Option<unsafe extern fn(a: *mut pa_mainloop_api,
                                        fd: c_int,
                                        events: pa_io_event_flags_t,
                                        cb: pa_io_event_cb_t,
                                        userdata: *mut c_void) -> *mut pa_io_event>,
    pub io_enable: Option<unsafe extern fn(e: *mut pa_io_event,
                                           events: pa_io_event_flags_t)>,
    pub io_free: Option<unsafe extern fn(e: *mut pa_io_event)>,
    pub io_set_destroy: Option<unsafe extern fn(e: *mut pa_io_event,
                                                cb: pa_io_event_destroy_cb_t)>,
    pub time_new: Option<unsafe extern fn(a: *mut pa_mainloop_api,
                                          tv: *const timeval,
                                          cb: pa_time_event_cb_t,
                                          userdata: *mut c_void) -> *mut pa_time_event>,
    pub time_restart: Option<unsafe extern fn(e: *mut pa_time_event,
                                              tv: *const timeval)>,
    pub time_free: Option<unsafe extern fn(e: *mut pa_time_event)>,
    pub time_set_destroy: Option<unsafe extern fn(e: *mut pa_time_event,
                                                  cb: pa_time_event_destroy_cb_t)>,
    pub defer_new: Option<unsafe extern fn(a: *mut pa_mainloop_api,
                                           cb: pa_defer_event_cb_t,
                                           userdata: *mut c_void) -> *mut pa_defer_event>,
    pub defer_enable: Option<unsafe extern fn(e: *mut pa_defer_event,
                                              b: c_int)>,
    pub defer_free: Option<unsafe extern fn(e: *mut pa_defer_event)>,
    pub defer_set_destroy: Option<unsafe extern fn(e: *mut pa_defer_event,
                                                   cb: pa_defer_event_destroy_cb_t)>,
    pub quit: Option<unsafe extern fn(a: *mut pa_mainloop_api, retval: c_int)>,
}
...
pub type pa_mainloop_api_once_cb_t = Option<unsafe extern fn(m: *mut pa_mainloop_api,
                                                             userdata: *mut c_void)>;
...
pub type pa_operation_notify_cb_t = Option<unsafe extern fn(o: *mut pa_operation,
                                                            userdata: *mut c_void)>;

pub enum pa_context { }
pub type pa_context_notify_cb_t = Option<unsafe extern fn(c: *mut pa_context,
                                                          userdata: *mut c_void)>;
pub type pa_context_success_cb_t = Option<unsafe extern fn(c: *mut pa_context,
                                                           success: c_int,
                                                           userdata: *mut c_void)>;
pub type pa_context_event_cb_t = Option<unsafe extern fn(c: *mut pa_context,
                                                         name: *const c_char,
                                                         p: *mut pa_proplist,
                                                         userdata: *mut c_void)>;
...
pub enum pa_stream { }
pub type pa_stream_success_cb_t = Option<unsafe extern fn(s: *mut pa_stream,
                                                          success: c_int,
                                                          userdata: *mut c_void)>;
pub type pa_stream_request_cb_t = Option<unsafe extern fn(p: *mut pa_stream,
                                                          nbytes: usize,
                                                          userdata: *mut c_void)>;
pub type pa_stream_notify_cb_t = Option<unsafe extern fn(p: *mut pa_stream,
                                                         userdata: *mut c_void)>;
pub type pa_stream_event_cb_t = Option<unsafe extern fn(p: *mut pa_stream,
                                                        name: *const c_char,
                                                        pl: *mut pa_proplist,
                                                        userdata: *mut c_void)>;
...
pub type pa_sink_info_cb_t = Option<unsafe extern fn(c: *mut pa_context,
...
pub type pa_source_info_cb_t = Option<unsafe extern fn(c: *mut pa_context,
...
pub type pa_server_info_cb_t = Option<unsafe extern fn(c: *mut pa_context,
...
pub type pa_module_info_cb_t = Option<unsafe extern fn(c: *mut pa_context,
                                                       i: *const pa_module_info,
                                                       eol: c_int,
                                                       userdata: *mut c_void)>;
pub type pa_context_index_cb_t = Option<unsafe extern fn(c: *mut pa_context,
                                                         idx: u32,
                                                         userdata: *mut c_void)>;
...
pub type pa_client_info_cb_t = Option<unsafe extern fn(c: *mut pa_context,
...
pub type pa_card_info_cb_t = Option<unsafe extern fn(c: *mut pa_context,
...
pub type pa_sink_input_info_cb_t = Option<unsafe extern fn(c: *mut pa_context,
...
pub type pa_source_output_info_cb_t = Option<unsafe extern fn(c: *mut pa_context,
...
pub type pa_stat_info_cb_t = Option<unsafe extern fn(c: *mut pa_context,
...
pub type pa_sample_info_cb_t = Option<unsafe extern fn(c: *mut pa_context,
...
pub type pa_autoload_info_cb_t = Option<unsafe extern fn(c: *mut pa_context,
                                                         i: *const pa_autoload_info,
                                                         eol: c_int,
                                                         userdata: *mut c_void)>;
pub type pa_context_subscribe_cb_t = Option<unsafe extern fn(c: *mut pa_context,
                                                             t: pa_subscription_event_type_t,
                                                             idx: u32,
                                                             userdata: *mut c_void)>;
pub type pa_context_play_sample_cb_t = Option<unsafe extern fn(c: *mut pa_context,
                                                               idx: u32,
                                                               userdata: *mut c_void)>;
...
pub type pa_poll_func = Option<unsafe extern fn(ufds: *mut pollfd,
                                                nfds: c_ulong,
                                                timeout: c_int,
                                                userdata: *mut c_void) -> c_int>;
pub enum pa_signal_event { }

pub type pa_signal_cb_t = Option<unsafe extern fn(api: *mut pa_mainloop_api,
                                                  e: *mut pa_signal_event,
                                                  sig: c_int,
                                                  userdata: *mut c_void)>;
pub type pa_signal_destroy_cb_t = Option<unsafe extern fn(api: *mut pa_mainloop_api,
                                                          e: *mut pa_signal_event,
                                                          userdata: *mut c_void)>;
