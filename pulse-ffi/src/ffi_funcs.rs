...
mod static_fns {
    ...
    extern "C" {
        ...
        pub fn pa_context_get_server_info(c: *const pa_context, cb: pa_server_info_cb_t, userdata: *mut c_void) -> *mut pa_operation;
        pub fn pa_context_get_sink_info_by_name(c: *const pa_context, name: *const c_char, cb: pa_sink_info_cb_t, userdata: *mut c_void) -> *mut pa_operation;
        pub fn pa_context_get_sink_info_list(c: *const pa_context, cb: pa_sink_info_cb_t, userdata: *mut c_void) -> *mut pa_operation;
        pub fn pa_context_get_sink_input_info(c: *const pa_context, idx: u32, cb: pa_sink_input_info_cb_t, userdata: *mut c_void) -> *mut pa_operation;
        pub fn pa_context_get_source_info_list(c: *const pa_context, cb: pa_source_info_cb_t, userdata: *mut c_void) -> *mut pa_operation;
        ...
        pub fn pa_context_subscribe(c: *mut pa_context, m: pa_subscription_mask_t, cb: pa_context_success_cb_t, userdata: *mut c_void) -> *mut pa_operation;
        ...
        pub fn pa_cvolume_set_balance(v: *mut pa_cvolume, map: *const pa_channel_map, new_balance: c_float) -> *mut pa_cvolume;
        pub fn pa_frame_size(spec: *const pa_sample_spec) -> usize;
        pub fn pa_mainloop_api_once(m: *mut pa_mainloop_api, callback: pa_mainloop_api_once_cb_t, userdata: *mut c_void);
        ...
        pub fn pa_stream_connect_playback(s: *mut pa_stream, dev: *const c_char, attr: *const pa_buffer_attr, flags: pa_stream_flags_t, volume: *const pa_cvolume, sync_stream: *const pa_stream) -> c_int;
        pub fn pa_stream_connect_record(s: *mut pa_stream, dev: *const c_char, attr: *const pa_buffer_attr, flags: pa_stream_flags_t) -> c_int;
        pub fn pa_stream_cork(s: *mut pa_stream, b: c_int, cb: pa_stream_success_cb_t, userdata: *mut c_void) -> *mut pa_operation;
        ...
        pub fn pa_stream_update_timing_info(p: *mut pa_stream, cb: pa_stream_success_cb_t, userdata: *mut c_void) -> *mut pa_operation;
        pub fn pa_stream_writable_size(p: *const pa_stream) -> usize;
        pub fn pa_stream_write(p: *mut pa_stream, data: *const c_void, nbytes: usize, free_cb: pa_free_cb_t, offset: i64, seek: pa_seek_mode_t) -> c_int;
...
mod dynamic_fns {
    ...
    pub unsafe fn pa_channel_map_can_balance(map: *const pa_channel_map) -> c_int {
        (::std::mem::transmute::<_, extern fn(*const pa_channel_map) -> c_int>(PA_CHANNEL_MAP_CAN_BALANCE))(map)
    }
    ...
    pub unsafe fn pa_channel_map_init(m: *mut pa_channel_map) -> *mut pa_channel_map {
        (::std::mem::transmute::<_, extern fn(*mut pa_channel_map) -> *mut pa_channel_map>(PA_CHANNEL_MAP_INIT))(m)
    }

    static mut PA_CONTEXT_CONNECT: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_context_connect(c: *mut pa_context, server: *const c_char, flags: pa_context_flags_t, api: *const pa_spawn_api) -> c_int {
        (::std::mem::transmute::<_, extern fn(*mut pa_context, *const c_char, pa_context_flags_t, *const pa_spawn_api) -> c_int>(PA_CONTEXT_CONNECT))(c, server, flags, api)
    }

    static mut PA_CONTEXT_DISCONNECT: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_context_disconnect(c: *mut pa_context) {
        (::std::mem::transmute::<_, extern fn(*mut pa_context)>(PA_CONTEXT_DISCONNECT))(c)
    }

    static mut PA_CONTEXT_DRAIN: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_context_drain(c: *mut pa_context, cb: pa_context_notify_cb_t, userdata: *mut c_void) -> *mut pa_operation {
        (::std::mem::transmute::<_, extern fn(*mut pa_context, pa_context_notify_cb_t, *mut c_void) -> *mut pa_operation>(PA_CONTEXT_DRAIN))(c, cb, userdata)
    }

    static mut PA_CONTEXT_GET_SERVER_INFO: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_context_get_server_info(c: *const pa_context, cb: pa_server_info_cb_t, userdata: *mut c_void) -> *mut pa_operation {
        (::std::mem::transmute::<_, extern fn(*const pa_context, pa_server_info_cb_t, *mut c_void) -> *mut pa_operation>(PA_CONTEXT_GET_SERVER_INFO))(c, cb, userdata)
    }

    static mut PA_CONTEXT_GET_SINK_INFO_BY_NAME: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_context_get_sink_info_by_name(c: *const pa_context, name: *const c_char, cb: pa_sink_info_cb_t, userdata: *mut c_void) -> *mut pa_operation {
        (::std::mem::transmute::<_, extern fn(*const pa_context, *const c_char, pa_sink_info_cb_t, *mut c_void) -> *mut pa_operation>(PA_CONTEXT_GET_SINK_INFO_BY_NAME))(c, name, cb, userdata)
    }

    static mut PA_CONTEXT_GET_SINK_INFO_LIST: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_context_get_sink_info_list(c: *const pa_context, cb: pa_sink_info_cb_t, userdata: *mut c_void) -> *mut pa_operation {
        (::std::mem::transmute::<_, extern fn(*const pa_context, pa_sink_info_cb_t, *mut c_void) -> *mut pa_operation>(PA_CONTEXT_GET_SINK_INFO_LIST))(c, cb, userdata)
    }

    static mut PA_CONTEXT_GET_SINK_INPUT_INFO: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_context_get_sink_input_info(c: *const pa_context, idx: u32, cb: pa_sink_input_info_cb_t, userdata: *mut c_void) -> *mut pa_operation {
        (::std::mem::transmute::<_, extern fn(*const pa_context, u32, pa_sink_input_info_cb_t, *mut c_void) -> *mut pa_operation>(PA_CONTEXT_GET_SINK_INPUT_INFO))(c, idx, cb, userdata)
    }

    static mut PA_CONTEXT_GET_SOURCE_INFO_LIST: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_context_get_source_info_list(c: *const pa_context, cb: pa_source_info_cb_t, userdata: *mut c_void) -> *mut pa_operation {
        (::std::mem::transmute::<_, extern fn(*const pa_context, pa_source_info_cb_t, *mut c_void) -> *mut pa_operation>(PA_CONTEXT_GET_SOURCE_INFO_LIST))(c, cb, userdata)
    }
    ...
    pub unsafe fn pa_context_get_state(c: *const pa_context) -> pa_context_state_t {
        (::std::mem::transmute::<_, extern fn(*const pa_context) -> pa_context_state_t>(PA_CONTEXT_GET_STATE))(c)
    }
    ...
    pub unsafe fn pa_context_new(mainloop: *mut pa_mainloop_api, name: *const c_char) -> *mut pa_context {
        (::std::mem::transmute::<_, extern fn(*mut pa_mainloop_api, *const c_char) -> *mut pa_context>(PA_CONTEXT_NEW))(mainloop, name)
    }

    static mut PA_CONTEXT_RTTIME_NEW: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_context_rttime_new(c: *const pa_context, usec: pa_usec_t, cb: pa_time_event_cb_t, userdata: *mut c_void) -> *mut pa_time_event {
        (::std::mem::transmute::<_, extern fn(*const pa_context, pa_usec_t, pa_time_event_cb_t, *mut c_void) -> *mut pa_time_event>(PA_CONTEXT_RTTIME_NEW))(c, usec, cb, userdata)
    }

    static mut PA_CONTEXT_SET_SINK_INPUT_VOLUME: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_context_set_sink_input_volume(c: *mut pa_context, idx: u32, volume: *const pa_cvolume, cb: pa_context_success_cb_t, userdata: *mut c_void) -> *mut pa_operation {
        (::std::mem::transmute::<_, extern fn(*mut pa_context, u32, *const pa_cvolume, pa_context_success_cb_t, *mut c_void) -> *mut pa_operation>(PA_CONTEXT_SET_SINK_INPUT_VOLUME))(c, idx, volume, cb, userdata)
    }

    static mut PA_CONTEXT_SET_STATE_CALLBACK: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_context_set_state_callback(c: *mut pa_context, cb: pa_context_notify_cb_t, userdata: *mut c_void) {
        (::std::mem::transmute::<_, extern fn(*mut pa_context, pa_context_notify_cb_t, *mut c_void)>(PA_CONTEXT_SET_STATE_CALLBACK))(c, cb, userdata)
    }

    static mut PA_CONTEXT_SET_SUBSCRIBE_CALLBACK: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_context_set_subscribe_callback(c: *mut pa_context, cb: pa_context_subscribe_cb_t, userdata: *mut c_void) {
        (::std::mem::transmute::<_, extern fn(*mut pa_context, pa_context_subscribe_cb_t, *mut c_void)>(PA_CONTEXT_SET_SUBSCRIBE_CALLBACK))(c, cb, userdata)
    }

    static mut PA_CONTEXT_SUBSCRIBE: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_context_subscribe(c: *mut pa_context, m: pa_subscription_mask_t, cb: pa_context_success_cb_t, userdata: *mut c_void) -> *mut pa_operation {
        (::std::mem::transmute::<_, extern fn(*mut pa_context, pa_subscription_mask_t, pa_context_success_cb_t, *mut c_void) -> *mut pa_operation>(PA_CONTEXT_SUBSCRIBE))(c, m, cb, userdata)
    }

    static mut PA_CONTEXT_UNREF: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_context_unref(c: *mut pa_context) {
        (::std::mem::transmute::<_, extern fn(*mut pa_context)>(PA_CONTEXT_UNREF))(c)
    }
    ...
    pub unsafe fn pa_cvolume_set(a: *mut pa_cvolume, channels: c_uint, v: pa_volume_t) -> *mut pa_cvolume {
        (::std::mem::transmute::<_, extern fn(*mut pa_cvolume, c_uint, pa_volume_t) -> *mut pa_cvolume>(PA_CVOLUME_SET))(a, channels, v)
    }

    static mut PA_CVOLUME_SET_BALANCE: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_cvolume_set_balance(v: *mut pa_cvolume, map: *const pa_channel_map, new_balance: c_float) -> *mut pa_cvolume {
        (::std::mem::transmute::<_, extern fn(*mut pa_cvolume, *const pa_channel_map, c_float) -> *mut pa_cvolume>(PA_CVOLUME_SET_BALANCE))(v, map, new_balance)
    }

    static mut PA_FRAME_SIZE: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_frame_size(spec: *const pa_sample_spec) -> usize {
        (::std::mem::transmute::<_, extern fn(*const pa_sample_spec) -> usize>(PA_FRAME_SIZE))(spec)
    }

    static mut PA_MAINLOOP_API_ONCE: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_mainloop_api_once(m: *mut pa_mainloop_api, callback: pa_mainloop_api_once_cb_t, userdata: *mut c_void) {
        (::std::mem::transmute::<_, extern fn(*mut pa_mainloop_api, pa_mainloop_api_once_cb_t, *mut c_void)>(PA_MAINLOOP_API_ONCE))(m, callback, userdata)
    }
    ...
    pub unsafe fn pa_operation_get_state(o: *const pa_operation) -> pa_operation_state_t {
        (::std::mem::transmute::<_, extern fn(*const pa_operation) -> pa_operation_state_t>(PA_OPERATION_GET_STATE))(o)
    }

    static mut PA_OPERATION_UNREF: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_operation_unref(o: *mut pa_operation) {
        (::std::mem::transmute::<_, extern fn(*mut pa_operation)>(PA_OPERATION_UNREF))(o)
    }
    ...
    pub unsafe fn pa_proplist_gets(p: *mut pa_proplist, key: *const c_char) -> *const c_char {
        (::std::mem::transmute::<_, extern fn(*mut pa_proplist, *const c_char) -> *const c_char>(PA_PROPLIST_GETS))(p, key)
    }

    static mut PA_RTCLOCK_NOW: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_rtclock_now() -> pa_usec_t {
        (::std::mem::transmute::<_, extern fn() -> pa_usec_t>(PA_RTCLOCK_NOW))()
    }
    ...
    pub unsafe fn pa_stream_begin_write(p: *mut pa_stream, data: *mut *mut c_void, nbytes: *mut usize) -> c_int {
        (::std::mem::transmute::<_, extern fn(*mut pa_stream, *mut *mut c_void, *mut usize) -> c_int>(PA_STREAM_BEGIN_WRITE))(p, data, nbytes)
    }

    static mut PA_STREAM_CANCEL_WRITE: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_stream_cancel_write(p: *mut pa_stream) -> c_int {
        (::std::mem::transmute::<_, extern fn(*mut pa_stream) -> c_int>(PA_STREAM_CANCEL_WRITE))(p)
    }

    static mut PA_STREAM_CONNECT_PLAYBACK: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_stream_connect_playback(s: *mut pa_stream, dev: *const c_char, attr: *const pa_buffer_attr, flags: pa_stream_flags_t, volume: *const pa_cvolume, sync_stream: *const pa_stream) -> c_int {
        (::std::mem::transmute::<_, extern fn(*mut pa_stream, *const c_char, *const pa_buffer_attr, pa_stream_flags_t, *const pa_cvolume, *const pa_stream) -> c_int>(PA_STREAM_CONNECT_PLAYBACK))(s, dev, attr, flags, volume, sync_stream)
    }

    static mut PA_STREAM_CONNECT_RECORD: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_stream_connect_record(s: *mut pa_stream, dev: *const c_char, attr: *const pa_buffer_attr, flags: pa_stream_flags_t) -> c_int {
        (::std::mem::transmute::<_, extern fn(*mut pa_stream, *const c_char, *const pa_buffer_attr, pa_stream_flags_t) -> c_int>(PA_STREAM_CONNECT_RECORD))(s, dev, attr, flags)
    }

    static mut PA_STREAM_CORK: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_stream_cork(s: *mut pa_stream, b: c_int, cb: pa_stream_success_cb_t, userdata: *mut c_void) -> *mut pa_operation {
        (::std::mem::transmute::<_, extern fn(*mut pa_stream, c_int, pa_stream_success_cb_t, *mut c_void) -> *mut pa_operation>(PA_STREAM_CORK))(s, b, cb, userdata)
    }

    static mut PA_STREAM_DISCONNECT: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_stream_disconnect(s: *mut pa_stream) -> c_int {
        (::std::mem::transmute::<_, extern fn(*mut pa_stream) -> c_int>(PA_STREAM_DISCONNECT))(s)
    }

    static mut PA_STREAM_DROP: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_stream_drop(p: *mut pa_stream) -> c_int {
        (::std::mem::transmute::<_, extern fn(*mut pa_stream) -> c_int>(PA_STREAM_DROP))(p)
    }
    ...
    pub unsafe fn pa_stream_get_buffer_attr(s: *const pa_stream) -> *const pa_buffer_attr {
        (::std::mem::transmute::<_, extern fn(*const pa_stream) -> *const pa_buffer_attr>(PA_STREAM_GET_BUFFER_ATTR))(s)
    }
    ...
    pub unsafe fn pa_stream_get_channel_map(s: *const pa_stream) -> *const pa_channel_map {
        (::std::mem::transmute::<_, extern fn(*const pa_stream) -> *const pa_channel_map>(PA_STREAM_GET_CHANNEL_MAP))(s)
    }
    ...
    pub unsafe fn pa_stream_get_device_name(s: *const pa_stream) -> *const c_char {
        (::std::mem::transmute::<_, extern fn(*const pa_stream) -> *const c_char>(PA_STREAM_GET_DEVICE_NAME))(s)
    }

    static mut PA_STREAM_GET_INDEX: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_stream_get_index(s: *const pa_stream) -> u32 {
        (::std::mem::transmute::<_, extern fn(*const pa_stream) -> u32>(PA_STREAM_GET_INDEX))(s)
    }
    ...
    pub unsafe fn pa_stream_get_latency(s: *const pa_stream, r_usec: *mut pa_usec_t, negative: *mut c_int) -> c_int {
        (::std::mem::transmute::<_, extern fn(*const pa_stream, *mut pa_usec_t, *mut c_int) -> c_int>(PA_STREAM_GET_LATENCY))(s, r_usec, negative)
    }
    ...
    pub unsafe fn pa_stream_get_sample_spec(s: *const pa_stream) -> *const pa_sample_spec {
        (::std::mem::transmute::<_, extern fn(*const pa_stream) -> *const pa_sample_spec>(PA_STREAM_GET_SAMPLE_SPEC))(s)
    }
    ...
    pub unsafe fn pa_stream_get_state(p: *const pa_stream) -> pa_stream_state_t {
        (::std::mem::transmute::<_, extern fn(*const pa_stream) -> pa_stream_state_t>(PA_STREAM_GET_STATE))(p)
    }
    ...
    pub unsafe fn pa_stream_get_time(s: *const pa_stream, r_usec: *mut pa_usec_t) -> c_int {
        (::std::mem::transmute::<_, extern fn(*const pa_stream, *mut pa_usec_t) -> c_int>(PA_STREAM_GET_TIME))(s, r_usec)
    }

    static mut PA_STREAM_NEW: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_stream_new(c: *mut pa_context, name: *const c_char, ss: *const pa_sample_spec, map: *const pa_channel_map) -> *mut pa_stream {
        (::std::mem::transmute::<_, extern fn(*mut pa_context, *const c_char, *const pa_sample_spec, *const pa_channel_map) -> *mut pa_stream>(PA_STREAM_NEW))(c, name, ss, map)
    }
    ...
    pub unsafe fn pa_stream_peek(p: *mut pa_stream, data: *mut *const c_void, nbytes: *mut usize) -> c_int {
        (::std::mem::transmute::<_, extern fn(*mut pa_stream, *mut *const c_void, *mut usize) -> c_int>(PA_STREAM_PEEK))(p, data, nbytes)
    }
    ...
    pub unsafe fn pa_stream_readable_size(p: *const pa_stream) -> usize {
        (::std::mem::transmute::<_, extern fn(*const pa_stream) -> usize>(PA_STREAM_READABLE_SIZE))(p)
    }
    ...
    pub unsafe fn pa_stream_set_state_callback(s: *mut pa_stream, cb: pa_stream_notify_cb_t, userdata: *mut c_void) {
        (::std::mem::transmute::<_, extern fn(*mut pa_stream, pa_stream_notify_cb_t, *mut c_void)>(PA_STREAM_SET_STATE_CALLBACK))(s, cb, userdata)
    }
    ...
    pub unsafe fn pa_stream_set_write_callback(p: *mut pa_stream, cb: pa_stream_request_cb_t, userdata: *mut c_void) {
        (::std::mem::transmute::<_, extern fn(*mut pa_stream, pa_stream_request_cb_t, *mut c_void)>(PA_STREAM_SET_WRITE_CALLBACK))(p, cb, userdata)
    }
    ...
    pub unsafe fn pa_stream_set_read_callback(p: *mut pa_stream, cb: pa_stream_request_cb_t, userdata: *mut c_void) {
        (::std::mem::transmute::<_, extern fn(*mut pa_stream, pa_stream_request_cb_t, *mut c_void)>(PA_STREAM_SET_READ_CALLBACK))(p, cb, userdata)
    }

    static mut PA_STREAM_UNREF: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_stream_unref(s: *mut pa_stream) {
        (::std::mem::transmute::<_, extern fn(*mut pa_stream)>(PA_STREAM_UNREF))(s)
    }

    static mut PA_STREAM_UPDATE_TIMING_INFO: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_stream_update_timing_info(p: *mut pa_stream, cb: pa_stream_success_cb_t, userdata: *mut c_void) -> *mut pa_operation {
        (::std::mem::transmute::<_, extern fn(*mut pa_stream, pa_stream_success_cb_t, *mut c_void) -> *mut pa_operation>(PA_STREAM_UPDATE_TIMING_INFO))(p, cb, userdata)
    }
    ...
    pub unsafe fn pa_stream_writable_size(p: *const pa_stream) -> usize {
        (::std::mem::transmute::<_, extern fn(*const pa_stream) -> usize>(PA_STREAM_WRITABLE_SIZE))(p)
    }

    static mut PA_STREAM_WRITE: *mut ::libc::c_void = 0 as *mut _;
    #[inline]
    pub unsafe fn pa_stream_write(p: *mut pa_stream, data: *const c_void, nbytes: usize, free_cb: pa_free_cb_t, offset: i64, seek: pa_seek_mode_t) -> c_int {
        (::std::mem::transmute::<_, extern fn(*mut pa_stream, *const c_void, usize, pa_free_cb_t, i64, pa_seek_mode_t) -> c_int>(PA_STREAM_WRITE))(p, data, nbytes, free_cb, offset, seek)
    }
    ...
    pub unsafe fn pa_sw_volume_from_linear(v: c_double) -> pa_volume_t {
        (::std::mem::transmute::<_, extern fn(c_double) -> pa_volume_t>(PA_SW_VOLUME_FROM_LINEAR))(v)
    }
    ...
    pub unsafe fn pa_threaded_mainloop_free(m: *mut pa_threaded_mainloop) {
        (::std::mem::transmute::<_, extern fn(*mut pa_threaded_mainloop)>(PA_THREADED_MAINLOOP_FREE))(m)
    }
    ...
    pub unsafe fn pa_threaded_mainloop_get_api(m: *mut pa_threaded_mainloop) -> *mut pa_mainloop_api {
        (::std::mem::transmute::<_, extern fn(*mut pa_threaded_mainloop) -> *mut pa_mainloop_api>(PA_THREADED_MAINLOOP_GET_API))(m)
    }
    ...
    pub unsafe fn pa_threaded_mainloop_in_thread(m: *mut pa_threaded_mainloop) -> c_int {
        (::std::mem::transmute::<_, extern fn(*mut pa_threaded_mainloop) -> c_int>(PA_THREADED_MAINLOOP_IN_THREAD))(m)
    }
    ...
    pub unsafe fn pa_threaded_mainloop_lock(m: *mut pa_threaded_mainloop) {
        (::std::mem::transmute::<_, extern fn(*mut pa_threaded_mainloop)>(PA_THREADED_MAINLOOP_LOCK))(m)
    }
    ...
    pub unsafe fn pa_threaded_mainloop_new() -> *mut pa_threaded_mainloop {
        (::std::mem::transmute::<_, extern fn() -> *mut pa_threaded_mainloop>(PA_THREADED_MAINLOOP_NEW))()
    }
    ...
    pub unsafe fn pa_threaded_mainloop_signal(m: *mut pa_threaded_mainloop, wait_for_accept: c_int) {
        (::std::mem::transmute::<_, extern fn(*mut pa_threaded_mainloop, c_int)>(PA_THREADED_MAINLOOP_SIGNAL))(m, wait_for_accept)
    }
    ...
    pub unsafe fn pa_threaded_mainloop_start(m: *mut pa_threaded_mainloop) -> c_int {
        (::std::mem::transmute::<_, extern fn(*mut pa_threaded_mainloop) -> c_int>(PA_THREADED_MAINLOOP_START))(m)
    }
    ...
    pub unsafe fn pa_threaded_mainloop_stop(m: *mut pa_threaded_mainloop) {
        (::std::mem::transmute::<_, extern fn(*mut pa_threaded_mainloop)>(PA_THREADED_MAINLOOP_STOP))(m)
    }
    ...
    pub unsafe fn pa_threaded_mainloop_unlock(m: *mut pa_threaded_mainloop) {
        (::std::mem::transmute::<_, extern fn(*mut pa_threaded_mainloop)>(PA_THREADED_MAINLOOP_UNLOCK))(m)
    }
    ...
    pub unsafe fn pa_threaded_mainloop_wait(m: *mut pa_threaded_mainloop) {
        (::std::mem::transmute::<_, extern fn(*mut pa_threaded_mainloop)>(PA_THREADED_MAINLOOP_WAIT))(m)
    }
